...
import { CATEGORY_COLORS, CATEGORY_ICONS } from "@/types/old-habit";
import {
  PieChart,
  Pie,
  Cell,
          ...
          <PieChart>
            ...
            <Tooltip
              ...
              formatter={(
                ...
                return [
                  `${safeValue} habit${safeValue !== 1 ? "s" : ""}`,
                  `${CATEGORY_ICONS[safeName as keyof typeof CATEGORY_ICONS]} ${safeName}`,
                ];
              }}
            />
            <Legend
