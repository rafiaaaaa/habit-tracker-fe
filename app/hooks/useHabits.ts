...
import type { Habit, Category, Frequency, PlanType } from "@/types/old-habit";

import { PLAN_LIMITS } from "@/types/old-habit";
...
// Generate realistic history for mock data
function generateHistory(
  ...
  for (let i = 0; i < daysBack; i++) {
    ...
    history.push({ date: formatLocalDate(date), completed });
  }
  return history;
}
...
const mockHabits: Habit[] = [
  {
    ...
    streak: 12,
    longestStreak: 21,
    history: generateHistory(90, 0.75),
  ...
  },
  {
    ...
    streak: 5,
    longestStreak: 14,
    history: generateHistory(60, 0.6),
  ...
  },
  {
    ...
    streak: 8,
    longestStreak: 8,
    history: generateHistory(45, 0.5),
